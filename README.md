...
[![CI](https://img.shields.io/github/actions/workflow/status/Build-with-Go/go-starter/ci.yml?branch=master)](https://github.com/Build-with-Go/go-starter/actions/workflows/ci.yml)
